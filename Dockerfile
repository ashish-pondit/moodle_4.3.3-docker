...
# moodle and moodledata file permissions
...
RUN chmod -R u+rwX,g+rwX,o+rX /var/www/moodledata
RUN find /var/www/moodledata/ -type d -exec chmod 700 {} ";"
RUN find /var/www/moodledata/ -type f -exec chmod 600 {} ";"
